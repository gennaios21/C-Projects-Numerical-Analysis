...
double P[N]={150*K,215*K,285*K,300*K};        // Με το Κ διαιρω καθε τιμη δια 1000


/////////////////////////////////////////////////////// πινακας H με 4 τιμες Tcal/h, H=yi
double H[N]={307*K,427*K,563*K,594*K};      // Με το Κ διαιρω καθε τιμη δια 1000 
...
int main() {
	...
	printf("Lignitis: H(P) = P(x) = %f*x^3 %f*x^2 + %f*x + %f\n",a3,a2,a1,a0);        //εκτυπωση του πολυωνυμου P(x)
