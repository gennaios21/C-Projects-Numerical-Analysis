...
int main() {
	...
	double E1a,E2a,E3a, E1b,E2b,E3b, Ea,Eb;   //μεταβλητες Εα,Ε1α,Ε2α,E3a για Εz με βημα h, Εb,Ε1b,Ε2b,E3b για Εz με βημα h/2
	...
	////////////////////////////////////////////////////////////////////////////////////////////// κωδικας για h
		...
		E1a=(h/3.0)*( Ez(a) + Ez(b) );         //χωριζω τον υπολογισμο σε 3 κομματια E1a,E2a,E3a, οπου Ε1α αφορα στα f(x0),f(xn) του κανονα Simpson
		E2a=0.0;
		E3a=0.0;
		Ea=0.0;
